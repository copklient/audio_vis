...
Visualizer.prototype = {
    ...
    _drawSpectrum: function(analyser) {
        // video ....
        $('video').attr('width', window.innerWidth, 'height', window.innerHeight, 'position', 'absolute','z-index', '-1','display', 'inline-block');
        var VideoCreate = $('#video');
        VideoCreate.src = 'video.mp4';
        var that = this,
